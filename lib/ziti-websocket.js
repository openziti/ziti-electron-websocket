...
/**
 * Create a `zitinet.Socket` and initiate a connection.
 *
 * @param {Object} options Connection options
 * @return {net.Socket} The newly created socket used to start the connection
 * @private
 */
// function zitinetConnect(options) {
//   options.path = options.socketPath;
//   return zitinet.connect(options);
// }
...
function socketOnData(chunk) {
  logger.debug('ZitiWebSocket socketOnData entered');
...
function socketOnEnd() {
  logger.debug('ZitiWebSocket socketOnEnd entered');
...
function socketOnError() {
  logger.debug('ZitiWebSocket socketOnError entered');
